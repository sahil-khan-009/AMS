                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link text-white" to="PatientAppointments">
                                <span><FaEnvelope /><span className="ms-2">Appointments</span></span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <div
                            ...
                            >
                                <span><FaUserDoctor /><span className="ms-2">Patients</span></span>
                        ...
                        <li className="nav-item">
                            <Link className="nav-link text-white" to="/DoctorDashboard">
                                <span><IoNotifications /><span className="ms-2">Notification</span></span>
                            </Link>
                        </li>
                        ...
                        <li className="nav-item">
                            <Link className="nav-link text-white" to="DoctorChat">
                                <span><RiChatNewFill /><span className="ms-2">Chat-Box</span></span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link text-white" to="/DoctorDashboard">
